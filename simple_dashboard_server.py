"""
Simplified WebSocket server for real-time SurgiInject dashboard
"""
...
class DashboardWebSocketServer:
    ...
    async def handle_message(self, websocket: websockets.WebSocketServerProtocol, data: Dict[str, Any]):
